<template>
  <nav>
    <div :class="['navs', { scrolled }]">
      <router-link to="/" class="flex items-center gap-2" @click="handleLinkClick">
        <div class="navss">
          <img :src="require('@/assets/bff3254df1cf22ed74923aaa65bc2a08.jpg')" alt="logo" class="logo" />
          <p class="">
            Ephrahim &nbsp;
      ...
      <ul class="list">
        <li v-for="nav in navLinks" :key="nav.id" :class="[
      ...
      <div class="menu-icon-container">
        <svg v-html="toggle ? closeIcon : menuIcon" @click="toggleMenu" class="menu-icon"></svg>
